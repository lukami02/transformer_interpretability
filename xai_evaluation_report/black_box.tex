...
\eqref{eq:size_dist}, a zatim se od $N$ pečeva nasumično bira
...
ponderisanog sistema najmanjih kvadrata dimenzija $M \times N$, RISE se oslanja isključivo na elementarne operacije sabiranja i deljenja. Dodatno, Kernel SHAP u praksi obično zahteva veći broj uzorkovanih maski da bi se regresiona procena stabilizovala i konvergirala ka pouzdanim Shapley vrednostima, dok jednostavnija procena metode RISE po pravilu konvergira uz manji broj uzoraka — usled oba faktora, ukupno vreme izvršavanja metode RISE je u praksi znatno manje.
