...
nastaje usled ekstremne perturbacije ulaza, u ovom radu se pored standardnog AUC-a 
...
nasumično premešani \cite{dosovitskiy2021vit}, što sugeriše da model 
...
Značajan pad korelacije ukazuje na to da metoda interpretabilnosti nije robusna na prisustvo 
...
obuhvata slike sa jasno istaknutim objektom — brod na moru i kraba sa 
karakterističnim kliještima. Na ovim primerima gotovo sve metode uspešno 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/eval/good_examples.jpg}
    \caption{Primeri sa jasno istaknutim objektom (brod na moru, kraba 
    sa kliještima). Za svaku sliku prikazana je originalna slika (levo) 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/eval/bad_examples.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.48\textwidth]{figures/eval/class_agnostic.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/eval/morf_lerf.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/eval/spearman_correlation.png}
...
najčišće i semantički najkoherentnije. Stoga, ukoliko je vreme izvršavanja 
